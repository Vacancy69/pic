            ...
            model = new DataGridModel<Projectinfo>()
            {
                ...
                public List<Projectinfo> fetchData(int first, int pageSize, String sortField, String sortOrder) {
                    ...
                    for (Projectinfo projectinfo : list) {
                        projectinfo.put("projectmanagername",
                                userService.getUserNameByUserGuid(projectinfo.getProjectmanager()));
                        projectinfo.put("projectusername",
                                service.getUserAllNamesByUserGuid(projectinfo.getProjectuser()));
