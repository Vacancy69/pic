...
public class ProjectinfoServiceImpl implements IProjectinfoService
{
    ...
    public Projectinfo findProjectinfoByProjectname(String projectname) {
        return new ProjectinfoService().findProjectinfoByProjectname(projectname);
    }

    @Override
    public Projectinfo findProjectinfoByProjectname(String projectNameOld, String projectNameNew) {
        return new ProjectinfoService().findProjectinfoByProjectname(projectNameOld, projectNameNew);
    }

    @Override
    public String getUserAllNamesByUserGuid(String allUserGuid) {
        return new ProjectinfoService().getUserAllNamesByUserGuid(allUserGuid);
    }
